...
MysqlManager::MysqlManager()
{
	...
	info.mFields["username"] = { "username", "varchar(64) NOT NULL COMMENT '用户名(手机号)'", "varchar(64)" };
	...
	info.mFields["signature"] = { "signature", "varchar(256) DEFAULT NULL COMMENT '个性签名'", "varchar(256)" };
